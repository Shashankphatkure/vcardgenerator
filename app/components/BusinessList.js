          ...
          {businesses.map((business) => (
            <li key={business.id} className="py-4">
              <div className="flex items-center justify-between">
                <Link href={`/business/${business.id}`} className="flex-1 block hover:bg-gray-50 transition duration-150 ease-in-out">
                ...
                <div className="flex space-x-2">
                  <Link href={`/edit-business/${business.id}`} className="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600">
                    Edit
                  </Link>
                  <button
